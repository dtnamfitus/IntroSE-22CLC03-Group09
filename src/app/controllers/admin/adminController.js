...
class adminController {
        ...
        bcrypt
          ...
          .then((result) => {
            if (result == true) {
              ...
              res.render('admin/update', {
                message: 'Wrong password. Can not update password!',
                layout: 'admin-main',
              });
          })
          .catch((err) => {
            res.render('admin/update', {
              message: 'Wrong password (err). Can not update password!',
              layout: 'admin-main',
            });
          });
      } else {
        res.render('admin/update', {
          message: 'Enter password again is wrong!!!',
          layout: 'admin-main',
        });
      }
    } else {
  ...
  async banned(req, res) {
    ...
    if (req.cookies.admin == null) res.redirect('/admin/home');
    else {
      const account = await userService.getAllUsers();
